...
int main() {
    ...
    printf("- Digite uma letra de 'A' a 'H', representando um dos 8 estados. \n");
    printf("- (Por exemplo, 'A' para AMAZONAS e 'B' para BAHIA): - \n");
    scanf(" %c", &estadoB);  // Ler o estado
    printf("- Agora, digite o código da carta: "); 
    printf("- Ele será uma combinação da Letra do estado + código da cidade - \n");
    printf("- (Por exemplo, 'A01, A02, B01, B02'): - \n");
    scanf("%s", codigo02);  // Ler o código
    printf("Digite o nome da cidade: ");

    // **CORREÇÃO AQUI** - Usar um scanf com um espaço extra no início para limpar o buffer
    scanf(" %[^\n]", cidade02);  // Lê o nome da cidade corretamente

    printf("Digite a população: ");
    scanf("%d", &populacao02);  // Ler a população
    printf("Digite a área (km²): ");
    scanf("%f", &area02);  // Ler a área
    printf("Digite o PIB da cidade: ");
    scanf("%f", &PIB02);  // Ler o PIB
    printf("Digite a quantidade de pontos turísticos: ");
    scanf("%d", &pturisticos02);  // Ler o número de pontos turísticos
    printf("\n");
    ...
    printf("População: %d habitantes\n", populacao01); // Exibe o número total da população
    printf("Área: %.2f km²\n", area01); // Exibe a área
    printf("PIB: R$ %.2f\n", PIB01); // Exibe o PIB
    ...
    printf("- CARTA 2 -\n");
    printf("Estado: %c\n", estadoB);  // Exibe o estado da segunda carta
    printf("Código: %s\n", codigo02);  // Exibe o código da segunda carta
    printf("Nome da cidade: %s\n", cidade02);  // Exibe o nome da segunda cidade
    printf("População: %d habitantes\n", populacao02);  // Exibe a população
    printf("Área: %.2f km²\n", area02);  // Exibe a área
    printf("PIB: R$ %.2f\n", PIB02);  // Exibe o PIB
    printf("Número de pontos turísticos: %d\n", pturisticos02);  // Exibe o número de pontos turísticos
    printf("\n");
